...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl bg-muted p-1 text-muted-foreground border-2",
      "border-blue-300 dark:border-white/30 dark:bg-gray-800/50 dark:backdrop-blur-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "text-blue-600 dark:text-white/70",
      className
    )}
    {...props}
  />
