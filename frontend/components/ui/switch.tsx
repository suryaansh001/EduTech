...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "border-blue-400 dark:border-white/40 data-[state=checked]:bg-blue-500 data-[state=unchecked]:bg-blue-100 dark:data-[state=checked]:bg-white dark:data-[state=unchecked]:bg-gray-700",
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "bg-white dark:bg-gray-900 data-[state=checked]:bg-white dark:data-[state=checked]:bg-gray-900",
      )}
    />
  </SwitchPrimitives.Root>
))
